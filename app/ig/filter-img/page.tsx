      ...
      <div className="max-w-3xl mx-auto py-10 px-6 space-y-8">
        ...
        <section className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-lg space-y-4">
          <textarea
            ...
            rows={10}
            placeholder={
              "johndoe|1|https://example.com/img1.jpg\njanedoe|2|https://example.com/img2.jpg"
            }
          ...
          <div className="flex flex-wrap gap-3 justify-end">
            <button
              ...
              } text-white px-5 py-2.5 rounded-lg font-medium transition shadow-sm hover:shadow-md`}
            >
